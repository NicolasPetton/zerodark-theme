...
(defun zerodark--load-colors (zerodark-true-color-p)
  (let ((class '((class color) (min-colors 89)))
        (default (if zerodark-true-color-p "#abb2bf" "#afafaf"))
        (light (if zerodark-true-color-p "#ccd4e3" "#d7d7d7"))
        (background (if zerodark-true-color-p "#282c34" "#333333"))
        (background-dark (if zerodark-true-color-p "#24282f" "#222222"))
        (background-darker (if zerodark-true-color-p "#22252c" "#222222"))
        (mode-line-inactive (if "#1c2129" "#222222"))
        (mode-line-active (if zerodark-true-color-p "#6f337e" "#875f87"))
        (background-lighter (if zerodark-true-color-p "#3a3f4b" "#5f5f5f"))
        (background-red (if zerodark-true-color-p "#4c3840" "#5f5f5f"))
        (bright-background-red (if zerodark-true-color-p "#744a5b" "#744a5b"))
        (background-purple (if zerodark-true-color-p "#48384c" "#5f5f5f"))
        (background-blue (if zerodark-true-color-p "#38394c" "#444444"))
        (bright-background-blue (if zerodark-true-color-p "#4e5079" "#4e5079"))
        (background-green (if zerodark-true-color-p "#3d4a41" "#5f5f5f"))
        (bright-background-green (if zerodark-true-color-p "#3f6d54" "#3f6d54"))
        (background-orange (if zerodark-true-color-p "#4a473d" "#5f5f5f"))
        (hl-line (if zerodark-true-color-p "#2c323b" "#333333"))
        (grey (if zerodark-true-color-p "#cccccc" "#cccccc"))
        (grey-dark (if zerodark-true-color-p "#666666" "#666666"))
        (highlight (if zerodark-true-color-p "#3e4451" "#5f5f5f"))
        (comment (if zerodark-true-color-p "#687080" "#707070"))
        (orange (if zerodark-true-color-p "#da8548" "#d7875f"))
        (orange-light (if zerodark-true-color-p "#ddbd78" "#d7af87"))
        (red (if zerodark-true-color-p "#ff6c6b" "#ff5f5f"))
        (purple (if zerodark-true-color-p "#c678dd" "#d787d7"))
        (purple-dark (if zerodark-true-color-p "#64446d" "#5f5f5f"))
        (blue (if zerodark-true-color-p "#61afef" "#5fafff"))
        (blue-dark (if zerodark-true-color-p "#1f5582" "#005f87"))
        (green (if zerodark-true-color-p "#98be65" "#87af5f"))
        (green-light (if zerodark-true-color-p "#9eac8c" "#afaf87"))
        (peach "PeachPuff3")
        (diff-added-background (if zerodark-true-color-p "#284437" "#284437"))
        (diff-added-refined-background (if zerodark-true-color-p "#1e8967" "#1e8967"))
        (diff-removed-background (if zerodark-true-color-p "#583333" "#580000"))
        (diff-removed-refined-background (if zerodark-true-color-p "#b33c49" "#b33c49"))
        (diff-current-background (if zerodark-true-color-p "#29457b" "#29457b"))
        (diff-current-refined-background (if zerodark-true-color-p "#4174ae" "#4174ae")))
...
(defun zerodark-load-true-colors ()
  (interactive)
  (zerodark--load-colors t))

(defun zerodark-load-256-colors ()
  (interactive)
  (zerodark--load-colors nil))
